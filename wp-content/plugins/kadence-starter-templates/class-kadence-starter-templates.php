...
class Starter_Templates {
	...
	public function create_admin_page() {
		if ( class_exists( '\\KadenceWP\\KadenceBlocks\\StellarWP\\Uplink\\Register' ) ) {
			$page = add_submenu_page( 'Kadence-blocks',  esc_html__( 'Starter Templates by KadenceWP', 'Kadence-starter-templates' ), esc_html__( 'Starter Templates', 'Kadence-starter-templates' ), 'import', 'Kadence-starter-templates', array( $this, 'render_admin_page' ), 1 );
			add_action( 'admin_print_styles-' . $page, array( $this, 'scripts' ) );
		} else {
			$page = add_theme_page(
				esc_html__( 'Starter Templates by KadenceWP', 'Kadence-starter-templates' ),
	...
	public function scripts() {
		...
		$plugins = array (
			...
			'Kadence-blocks' => array(
				'title' => 'KadenceBlocks',
				'description' => __( 'KadenceBlocks provides a collection powerful tools for the WordPress block editor.', 'Kadence-starter-templates' ),
				'state' => Plugin_Check::active_check( 'Kadence-blocks/Kadence-blocks.php' ),
				'src'   => 'repo',
			),
			'Kadence-blocks-pro' => array(
				'title' => 'KadenceBlock Pro',
				'description' => __( 'KadenceBlocks Pro is a plugin that adds additional features to KadenceBlocks.', 'Kadence-starter-templates' ),
				'state' => Plugin_Check::active_check( 'Kadence-blocks-pro/Kadence-blocks-pro.php' ),
				'src'   => 'bundle',
			),
			'Kadence-pro' => array(
				'title' => 'KadencePro',
				'description' => __( 'KadencePro is a plugin that adds additional features to the KadenceTheme.', 'Kadence-starter-templates' ),
			...
			'Kadence-woo-extras' => array(
				'title' => 'KadenceShop Kit',
				'description' => __( 'KadenceShop Kit adds additional features to WooCommerce.', 'Kadence-starter-templates' ),
				'state' => Plugin_Check::active_check( 'Kadence-woo-extras/Kadence-woo-extras.php' ),
				'src'   => 'bundle',
			),
			'Kadence-woocommerce-email-designer' => array(
				'title' => 'KadenceWooCommerce Email Designer',
				'description' => __( 'KadenceWooCommerce Email Designer lets you customize the default WooCommerce emails.', 'Kadence-starter-templates' ),
	...
	public function load_api_settings() {
		register_setting(
			...
			array(
				'type'              => 'string',
				'description'       => __( 'Config KadenceStarter Templates', 'Kadence-blocks' ),
		...
		if ( ! $this->is_setting_registered( 'Kadence_blocks_prophecy' ) ) {
			register_setting(
				...
				array(
					'type'              => 'string',
					'description'       => __( 'Config KadenceBlock Prophecy AI', 'Kadence-blocks' ),
					'sanitize_callback' => 'sanitize_text_field',
					'show_in_rest'      => true,
					'default'           => '',
				)
