...
class Library_REST_Controller extends WP_REST_Controller {
	...
	/**
	 * API email for Kadencemembership
	 *
	 * @var string
	 */
	private $api_email = '';
	...
	public function get_collection_params() {
		...
		$query_params[ self::PROP_API_KEY ] = array(
			'description'       => __( 'KadenceLicense Key.', 'Kadence-starter-templates' ),
			'type'              => 'string',
			'sanitize_callback' => 'sanitize_text_field',
		);
		$query_params[ self::PROP_API_EMAIL ] = array(
			'description'       => __( 'KadenceLicense Email.', 'Kadence-starter-templates' ),
			'type'              => 'string',
			'sanitize_callback' => 'sanitize_text_field',
		);
		$query_params[ self::PROP_API_PRODUCT ] = array(
			'description'       => __( 'KadenceLicense Product ID.', 'Kadence-starter-templates' ),
			'type'              => 'string',
			'sanitize_callback' => 'sanitize_text_field',
		);
