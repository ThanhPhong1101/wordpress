...
class Customizer_Import_Export {
	...
	/**
	 * Imports uploaded Kadencewoo email settings
	 *
	 * @access private
	 * @param object $wp_customize An instance of WP_Customize_Manager.
	 * @return void
	...
	private static function import_data( $wp_customize ) {
		...
		if ( $data['template'] != $template ) {
			$Kadence_starter_import_error = __( 'Error importing settings! The settings you uploaded are not for the KadenceTheme.', 'Kadence-starter-templates' );
			return;
		}
		// Import images.
